...
const peer_review_1 = require("./peer-review");
...
test("18. globalPeerReview 싱글톤", () => {
    assertDefined(peer_review_1.globalPeerReview, "globalPeerReview 없음");
    assert(peer_review_1.globalPeerReview instanceof peer_review_1.PeerReviewSystem, "PeerReviewSystem 인스턴스여야 함");
});
// ─── 2. 내장 함수 테스트 ────────────────────────────────────────────────────
...
if (failed > 0)
    process.exit(1);
//# sourceMappingURL=test-phase127-peer-review.js.map