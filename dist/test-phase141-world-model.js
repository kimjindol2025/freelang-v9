...
test("1. WorldModel 생성", () => {
    const wm = new world_model_1.WorldModel();
...
function registerWorldModelBuiltins(interp) {
    const ctx = interp.context;
    const wm = world_model_1.globalWorldModel;
...
test("22. world-update-entity 빌트인", () => {
    ...
    const updateResult = world_model_1.globalWorldModel.updateEntity("up-test", { population: 1000000 });
...
//# sourceMappingURL=test-phase141-world-model.js.map