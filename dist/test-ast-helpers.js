...
const functions = (0, ast_helpers_1.extractFunctions)(ast2);
...
const symbols = body3 ? (0, ast_helpers_1.extractSymbols)(body3) : [];
...
const moduleBlock = ast4[0];
const exportedFunctions = (0, ast_helpers_1.extractArrayField)(moduleBlock, "exports");
...
const blocks5 = ast5
    .filter((b) => typeof b === "object" && b.type === "FUNC")
    .map((b) => b);
const commonType = (0, ast_helpers_1.extractCommonType)(blocks5);
...
const blocks6 = ast6
    .filter((b) => typeof b === "object" && b.type === "FUNC")
    .map((b) => b);
const depGraph = (0, ast_helpers_1.buildDependencyGraph)(blocks6);
...
console.log("=".repeat(60));
const sorted = (0, ast_helpers_1.topologicalSort)(depGraph);
...
//# sourceMappingURL=test-ast-helpers.js.map