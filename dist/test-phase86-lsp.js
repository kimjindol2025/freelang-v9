...
test("FLLanguageServer 인스턴스 생성", () => {
    const server = new lsp_server_1.FLLanguageServer();
...
test("내장 함수 위치에서 hover → 설명 문자열 반환", () => {
    ...
    assertContains(result, "map", "'map' 설명에 'map' 포함");
});
...
function runMultiInterp(src) {
    const interp = new interpreter_1.Interpreter();
    interp.interpret((0, parser_1.parse)((0, lexer_1.lex)(src)));
    return interp;
}
function evalIn56(interp, src) {
    interp.interpret((0, parser_1.parse)((0, lexer_1.lex)(src)));
    return interp.context.lastValue;
}
...
//# sourceMappingURL=test-phase86-lsp.js.map