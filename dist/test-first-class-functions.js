...
try {
    ...
    const tokens3 = (0, lexer_1.lex)(test3Code);
    const blocks3 = (0, parser_1.parse)(tokens3);
    interp3.interpret(blocks3);
    const testFunc3 = interp3["context"].functions.get("run-test3");
    if (testFunc3) {
        const result3 = interp3.eval(testFunc3.body);
...
try {
    ...
    const tokens4 = (0, lexer_1.lex)(test4Code);
    const blocks4 = (0, parser_1.parse)(tokens4);
    interp4.interpret(blocks4);
    const testFunc4 = interp4["context"].functions.get("run-test4");
    if (testFunc4) {
        const result4 = interp4.eval(testFunc4.body);
...
`;
try {
    const interp5 = new interpreter_1.Interpreter();
    const tokens5 = (0, lexer_1.lex)(test5Code);
    const blocks5 = (0, parser_1.parse)(tokens5);
    interp5.interpret(blocks5);
    const testFunc5 = interp5["context"].functions.get("run-test5");
    if (testFunc5) {
        const result5 = interp5.eval(testFunc5.body);
...
try {
    ...
    const tokens6 = (0, lexer_1.lex)(test6Code);
    const blocks6 = (0, parser_1.parse)(tokens6);
    interp6.interpret(blocks6);
    const testFunc6 = interp6["context"].functions.get("run-test6");
    if (testFunc6) {
        const result6 = interp6.eval(testFunc6.body);
...
try {
    ...
    const tokens7 = (0, lexer_1.lex)(test7Code);
    const blocks7 = (0, parser_1.parse)(tokens7);
    interp7.interpret(blocks7);
    const testFunc7 = interp7["context"].functions.get("run-test7");
    if (testFunc7) {
        const result7 = interp7.eval(testFunc7.body);
...
`;
try {
    const interp8 = new interpreter_1.Interpreter();
    const tokens8 = (0, lexer_1.lex)(test8Code);
    const blocks8 = (0, parser_1.parse)(tokens8);
    interp8.interpret(blocks8);
    const testFunc8 = interp8["context"].functions.get("run-test8");
    if (testFunc8) {
        const result8 = interp8.eval(testFunc8.body);
...
//# sourceMappingURL=test-first-class-functions.js.map