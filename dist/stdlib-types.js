...
exports.BUILTIN_TYPE_SIGS = void 0;
exports.getBuiltinTypeSig = getBuiltinTypeSig;
/**
 * 내장 연산자/함수의 타입 시그니처
 * params: 각 인수의 기대 타입 (any → 검증 스킵)
 * ret: 반환값 타입
 */
exports.BUILTIN_TYPE_SIGS = {
 ...
 * 내장 함수 타입 시그니처 조회
 */
function getBuiltinTypeSig(op) {
    return exports.BUILTIN_TYPE_SIGS[op] ?? null;
}
//# sourceMappingURL=stdlib-types.js.map