...
test("Gen1 lexer로 lexer.fl 렉싱 (1800+ tokens)", () => {
    ...
    if (tokens.length < 1000)
        throw new Error(`too few tokens: ${tokens.length}`);
...
test("standaloneCompile(lexer.fl) → Gen2 lexer", () => {
    ...
    if (typeof lexer2JS !== "string" || lexer2JS.length === 0)
...
test("standaloneCompile(parser.fl) → Gen2 parser", () => {
    ...
    if (typeof parser2JS !== "string" || parser2JS.length === 0)
        throw new Error("empty");
...
test("standaloneCompile(codegen.fl) → Gen2 codegen", () => {
    ...
    if (typeof codegen2JS !== "string" || codegen2JS.length === 0)
        throw new Error("empty");
...
if (failed > 0)
    process.exit(1);
process.exit(0);
//# sourceMappingURL=test-phase31-gen2-lexer.js.map