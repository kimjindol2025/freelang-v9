...
function assertClose(a, b, delta = 0.001, msg) {
...
test("1. HypothesisTester 생성", () => {
    const tester = new hypothesis_1.HypothesisTester();
    assert(tester instanceof hypothesis_1.HypothesisTester, "should be HypothesisTester instance");
});
test("2. test() 기본 동작", () => {
    const tester = new hypothesis_1.HypothesisTester();
...
test("17. globalTester 싱글톤", () => {
    assert(hypothesis_1.globalTester instanceof hypothesis_1.HypothesisTester, "globalTester should be HypothesisTester");
    const result = hypothesis_1.globalTester.test({
        claim: "싱글톤 테스트",
        test: () => "ok",
        evaluate: () => 0.8,
    });
...
test("18. hypothesis 내장함수 (accepted)", () => {
    ...
    const r = hypothesis_1.globalTester.test({
        claim: "2+2=4",
        test: () => 4,
        evaluate: () => 0.9,
        maxAttempts: 1,
...
test("20. hypothesis-compete 내장함수", () => {
    // compete 직접 테스트
    const winner = hypothesis_1.globalTester.compete([
...
//# sourceMappingURL=test-phase111-hypothesis.js.map