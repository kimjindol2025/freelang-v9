...
const stringTokens = (0, lexer_1.lex)(stringCode);
const stringBlocks = (0, parser_1.parse)(stringTokens);
...
try {
    ...
    console.log(`\n🎯 all-string-tests-pass: ❌ ERROR - ${e.message}`);
}
//# sourceMappingURL=test-stdlib-string.js.map