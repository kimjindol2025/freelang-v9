...
const tokens = (0, lexer_1.lex)(patternsCode);
const blocks = (0, parser_1.parse)(tokens);
console.log(`✅ Parsed ${blocks.length} blocks\n`);
// Count function blocks
const funcBlocks = blocks.filter((b) => b.kind === "block" && b.type === "FUNC");
...
const tokens1 = (0, lexer_1.lex)(literalTestCode);
...
const tokens2 = (0, lexer_1.lex)(varTestCode);
...
const tokens3 = (0, lexer_1.lex)(listTestCode);
...
const tokens4 = (0, lexer_1.lex)(restTestCode);
...
const tokens5 = (0, lexer_1.lex)(wildcardTestCode);
...
const tokens6 = (0, lexer_1.lex)(multiPatternCode);
...
const tokens7 = (0, lexer_1.lex)(defaultTestCode);
...
//# sourceMappingURL=test-stdlib-patterns.js.map