...
exports.createCacheModule = createCacheModule;
...
function createCacheModule() {
    return {
        ...
        "cache_del": (key) => _cache.delete(key),
        ...
        "wait_for_cache": (key, timeoutMs = 30000, intervalMs = 50) => {
...
//# sourceMappingURL=stdlib-cache.js.map