...
exports.globalSwarm = exports.Swarm = void 0;
class Swarm {
    optimize(config) {
        const { objective, particles: n = 10, iterations: maxIter = 50, bounds = [0, 1], tolerance = 0.001, } = config;
