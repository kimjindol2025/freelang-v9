...
test("TC-6: [TS] drop(5, range) + take(3)", () => {
    const bigRange = (0, lazy_seq_1.rangeSeq)(0); // 무한 자연수
    const dropped = (0, lazy_seq_1.drop)(5, bigRange);
    const result = (0, lazy_seq_1.take)(3, dropped);
...
test("TC-13: [FL] toDisplayString lazy-seq 미리보기", () => {
    ...
    const disp = interp.toDisplayString(ctx.lastValue);
...
//# sourceMappingURL=test-phase69-lazy.js.map