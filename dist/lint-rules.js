...
exports.ALL_RULES = exports.deadCode = exports.unreachableMatch = exports.emptyBody = exports.arityCheck = exports.shadowedVars = exports.unusedBindings = exports.undefinedVars = void 0;
    ...
    if (params.length === 1 && params[0].kind === "block" && params[0].type === "Array") {
        ...
        for (const item of items) {
            ...
            // [[name type]] 형태
                ...
                if (inner && inner[0]?.kind === "variable")
                    result.push(inner[0].name);
            }
        }
        return result;
    }
...
exports.emptyBody = {
    ...
    check(ast, ctx) {
        ...
        for (const node of ast) {
            ...
            else if (!Array.isArray(bodyField) && bodyField.kind === "block" &&
                bodyField.type === "Array") {
                ...
                for (let i = 0; i < node.args.length; i++) {
                    ...
                    if (clause.kind === "block" && clause.type === "Array") {
                        ...
                        if (Array.isArray(items) && items.length >= 1) {
                            ...
                            if ((condExpr.kind === "literal" && condExpr.value === true) ||
...
function getRuleByName(name) {
    return exports.ALL_RULES.find(r => r.name === name);
}
