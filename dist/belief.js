...
exports.globalBeliefs = exports.BeliefSystem = void 0;
class BeliefSystem {
    constructor() {
    ...
    // 모든 신념 목록
    list() { return [...this.beliefs.values()]; }
    // 가장 확신이 높은 신념
    strongest() {
        const all = this.list();
        if (all.length === 0)
    ...
    // 신념 삭제
    forget(claim) { return this.beliefs.delete(claim); }
    // 크기
    size() { return this.beliefs.size; }
}
exports.BeliefSystem = BeliefSystem;
exports.globalBeliefs = new BeliefSystem();
