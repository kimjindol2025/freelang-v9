...
`;
    ...
    console.log(`✅ ${allExists && (context.typeClassInstances?.size ?? 0) >= 4
        ? "PASS"
        : "FAIL"}\n`);
}
catch (e) {
...
//# sourceMappingURL=test-typeclass-monad-instances-day4.js.map