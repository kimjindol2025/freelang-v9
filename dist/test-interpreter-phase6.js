...
console.log("\nParsing and interpreting...");
try {
    const tokens = (0, lexer_1.lex)(selectiveImportCode);
    const ast = (0, parser_1.parse)(tokens);
    const interp = new interpreter_1.Interpreter();
    const ctx = interp.interpret(ast);
...
console.log("\nParsing and interpreting...");
try {
    const tokens = (0, lexer_1.lex)(aliasImportCode);
    const ast = (0, parser_1.parse)(tokens);
    const interp = new interpreter_1.Interpreter();
    const ctx = interp.interpret(ast);
...
console.log("\nParsing and interpreting...");
try {
    const tokens = (0, lexer_1.lex)(multiModuleCode);
    const ast = (0, parser_1.parse)(tokens);
    const interp = new interpreter_1.Interpreter();
    const ctx = interp.interpret(ast);
...
//# sourceMappingURL=test-interpreter-phase6.js.map