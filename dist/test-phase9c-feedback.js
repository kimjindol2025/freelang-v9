...
try {
    ...
    if (result?.kind === "reasoning-sequence-result" &&
        ...
        console.log(`⚠️  TEST 2 PARTIAL: Expected 2 iterations and feedback, got ${result?.iterations}, feedback: ${result?.feedbackTriggered}`);
    }
}
catch (e) {
...
try {
    ...
    if (result?.kind === "reasoning-sequence-result" &&
        ...
        console.log(`❌ TEST 3 FAIL: Expected max 3 iterations, got ${result?.iterations}`);
    }
}
catch (e) {
...
//# sourceMappingURL=test-phase9c-feedback.js.map