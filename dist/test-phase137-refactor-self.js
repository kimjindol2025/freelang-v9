...
test("1. SelfRefactorer 생성", () => {
    const r = new refactor_self_1.SelfRefactorer();
...
test("25. impact 분류 (low/medium/high)", () => {
    ...
    for (const s of allSuggestions) {
        assert(["low", "medium", "high"].includes(s.impact), `impact '${s.impact}'는 low/medium/high 중 하나여야 함`);
    }
...
//# sourceMappingURL=test-phase137-refactor-self.js.map