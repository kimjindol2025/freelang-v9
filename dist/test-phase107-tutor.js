...
const fl_tutor_1 = require("./fl-tutor");
...
// ─── 1. FLTutor 생성 ───────────────────────────────────
test("1. FLTutor 생성", () => {
    const tutor = new fl_tutor_1.FLTutor();
    assert(tutor instanceof fl_tutor_1.FLTutor, "FLTutor 인스턴스여야 함");
});
// ─── 2. FL_EXAMPLES 내장 예제 15개 이상 ─────────────────
test("2. FL_EXAMPLES 내장 예제 15개 이상", () => {
    assert(fl_tutor_1.FL_EXAMPLES.length >= 15, `예제 수: ${fl_tutor_1.FL_EXAMPLES.length}`);
});
// ─── 3. findByConcept() hit ──────────────────────────────
...
test("26. globalTutor 싱글톤 검증", () => {
    assert(fl_tutor_1.globalTutor instanceof fl_tutor_1.FLTutor, "globalTutor는 FLTutor 인스턴스");
    assert(fl_tutor_1.globalTutor.size() >= 15, "globalTutor에 15개 이상 예제");
});
// ─── 보너스: lessonMarkdown ──────────────────────────────
...
//# sourceMappingURL=test-phase107-tutor.js.map