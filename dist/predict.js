...
exports.globalPredictor = exports.Predictor = void 0;
// 통계 유틸리티
function mean(data) {
    if (data.length === 0)
        return 0;
...
// 잔차 표준 오차 계산
function residualStdError(data, slope, intercept) {
    const n = data.length;
    if (n < 3)
        return stddev(data) * 0.5;
...
exports.globalPredictor = new Predictor();
