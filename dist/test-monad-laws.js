...
function monadEquals(left, right) {
...
`;
    ...
    if (passed) {
        console.log(`✅ PASS: bind (ok 5) f = f(5)\n   Left:  ${JSON.stringify(leftSide)}\n   Right: ${JSON.stringify(rightSide)}\n`);
    }
    else {
        console.log(`❌ FAIL: Values not equal\n   Left:  ${JSON.stringify(leftSide)}\n   Right: ${JSON.stringify(rightSide)}\n`);
    }
}
catch (e) {
...
`;
    ...
    const passed = monadEquals(leftSide, rightSide);
    if (passed) {
        console.log(`✅ PASS: bind (some 5) f = f(5)\n   Left:  ${JSON.stringify(leftSide)}\n   Right: ${JSON.stringify(rightSide)}\n`);
    }
    else {
        console.log(`❌ FAIL: Values not equal\n   Left:  ${JSON.stringify(leftSide)}\n   Right: ${JSON.stringify(rightSide)}\n`);
    }
...
`;
    ...
    const passed = monadEquals(leftSide, rightSide);
    if (passed) {
        console.log(`✅ PASS: bind m (fn [x] (ok x)) = m\n   Left:  ${JSON.stringify(leftSide)}\n   Right: ${JSON.stringify(rightSide)}\n`);
    }
    else {
        console.log(`❌ FAIL: Values not equal\n   Left:  ${JSON.stringify(leftSide)}\n   Right: ${JSON.stringify(rightSide)}\n`);
    }
...
`;
    ...
    const passed = monadEquals(leftSide, rightSide);
    if (passed) {
        console.log(`✅ PASS: bind m (fn [x] (some x)) = m\n   Left:  ${JSON.stringify(leftSide)}\n   Right: ${JSON.stringify(rightSide)}\n`);
    }
    else {
        console.log(`❌ FAIL: Values not equal\n   Left:  ${JSON.stringify(leftSide)}\n   Right: ${JSON.stringify(rightSide)}\n`);
    }
...
`;
    ...
    const passed = monadEquals(leftSide, rightSide);
    if (passed) {
        console.log(`✅ PASS: bind m (fn [x] [x]) = m\n   Left:  [${leftSide.join(", ")}]\n   Right: [${rightSide.join(", ")}]\n`);
    }
    else {
        console.log(`❌ FAIL: Values not equal\n   Left:  [${leftSide.join(", ")}]\n   Right: [${rightSide.join(", ")}]\n`);
    }
...
`;
    ...
    const passed = monadEquals(leftSide, rightSide);
    if (passed) {
        console.log(`✅ PASS: (bind (bind m f) g) = bind m (fn [x] (bind (f x) g))\n   Left:  ${JSON.stringify(leftSide)}\n   Right: ${JSON.stringify(rightSide)}\n`);
    }
    else {
        console.log(`❌ FAIL: Values not equal\n   Left:  ${JSON.stringify(leftSide)}\n   Right: ${JSON.stringify(rightSide)}\n`);
    }
...
`;
    ...
    const passed = monadEquals(leftSide, rightSide);
    if (passed) {
        console.log(`✅ PASS: Associativity for Option monad\n   Left:  ${JSON.stringify(leftSide)}\n   Right: ${JSON.stringify(rightSide)}\n`);
    }
    else {
        console.log(`❌ FAIL: Values not equal\n   Left:  ${JSON.stringify(leftSide)}\n   Right: ${JSON.stringify(rightSide)}\n`);
    }
...
`;
    ...
    const passed = monadEquals(leftSide, rightSide);
    if (passed) {
        console.log(`✅ PASS: Associativity for List monad\n   Left:  [${leftSide.join(", ")}]\n   Right: [${rightSide.join(", ")}]\n`);
    }
    else {
        console.log(`❌ FAIL: Values not equal\n   Left:  [${leftSide.join(", ")}]\n   Right: [${rightSide.join(", ")}]\n`);
    }
...
console.log("   All three monad laws (Left Identity, Right Identity, Associativity)");
console.log("   are formally verified for Result, Option, and List monads.\n");
//# sourceMappingURL=test-monad-laws.js.map