...
exports.handleSearchBlock = handleSearchBlock;
exports.handleLearnBlock = handleLearnBlock;
exports.handleReasoningBlock = handleReasoningBlock;
function handleSearchBlock(interp, searchBlock) {
    ...
    try {
        ...
        if (!interp.context.cache)
            interp.context.cache = new Map();
        ...
        return { kind: "search-error", query, message: error.message, timestamp: new Date().toISOString() };
    }
}
function handleLearnBlock(interp, learnBlock) {
    ...
    try {
        ...
        return { kind: "learn-error", key, message: error.message, timestamp: new Date().toISOString() };
    }
}
function handleReasoningBlock(interp, reasoningBlock) {
    ...
    if (!interp.context.reasoning)
        interp.context.reasoning = new Map();
    ...
    const stageEmoji = { observe: "👀", analyze: "🔍", decide: "🎯", act: "⚡", verify: "✅" };
...
//# sourceMappingURL=eval-ai-handlers.js.map