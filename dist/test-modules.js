...
`;
    ...
    const moduleRegistry = interp1.context.modules || new Map();
...
`;
    ...
    const moduleRegistry = interp2.context.modules || new Map();
...
`;
    ...
    const moduleRegistry = interp6.context.modules || new Map();
