...
const mathTokens = (0, lexer_1.lex)(mathCode);
const mathBlocks = (0, parser_1.parse)(mathTokens);
...
try {
    ...
    console.log(`\n🎯 all-math-tests-pass: ❌ ERROR - ${e.message}`);
}
//# sourceMappingURL=test-stdlib-math.js.map