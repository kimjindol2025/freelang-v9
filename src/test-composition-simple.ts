...
`;
  ...
  const func1 = (interp as any).context.functions.get("test1");
...
`;
  ...
  const func2 = (interp as any).context.functions.get("test2");
...
`;
  ...
  const func3 = (interp as any).context.functions.get("test3");
...
`;
  ...
  const func4 = (interp as any).context.functions.get("test4");
