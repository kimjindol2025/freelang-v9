...
// 문제 특성 분석 → 전략 점수
function scoreStrategy(problem: string, strategy: ReasoningStrategy): StrategyScore {
...
export class MetaReasoner {
  ...
  constructor(strategies: ReasoningStrategy[] = [...ALL_STRATEGIES]) {
...
export const globalMetaReasoner = new MetaReasoner();
