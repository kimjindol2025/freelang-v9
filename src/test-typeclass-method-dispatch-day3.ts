...
`;
  ...
  console.log(
    `✅ ${
      monadClass && resultInstance && resultInstance.implementations.has("pure")
        ? "PASS"
        : "FAIL"
    }\n`
  );
...
`;
  ...
  console.log(
    `✅ ${
      listInstance && listInstance.concreteType === "List" && fmapMethod
        ? "PASS"
        : "FAIL"
    }\n`
  );
...
`;
  ...
  console.log(
    `✅ ${
      context.typeClassInstances?.has(resultKey) &&
...
`;
  ...
  console.log(
    `✅ ${
      monadClass && functorClass && resultMoand && listFunctor
        ? "PASS"
        : "FAIL"
    }\n`
  );
