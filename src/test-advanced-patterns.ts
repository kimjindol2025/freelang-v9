...
`;
  ...
  console.log(
    `✅ PASS: (1|2|3) matches 2 → "${result1}" (expected "one two three")\n`
  );
} catch (e: any) {
...
`;
  ...
  console.log(
    `✅ PASS: (1|2|3) matches 2 → "${result2}" (expected "small")\n`
  );
} catch (e: any) {
  console.log(`❌ Error: ${e.message}\n`);
}
...
`;
  ...
  console.log(
    `✅ PASS: [\$a 2 \$b] matches [1 2 3] → "${result3}" (expected "matches")\n`
  );
} catch (e: any) {
  console.log(`❌ Error: ${e.message}\n`);
}
...
`;
  ...
  console.log(
    `✅ PASS: (> x 10) AND (< x 20) for x=15 → "${result4}" (expected "middle")\n`
  );
} catch (e: any) {
  console.log(`❌ Error: ${e.message}\n`);
}
...
`;
  ...
  console.log(
    `✅ PASS: List [5 10] with guard → "${result5}" (expected "valid pair")\n`
  );
} catch (e: any) {
  console.log(`❌ Error: ${e.message}\n`);
}
...
`;
  ...
  console.log(
    `✅ PASS: [\$x & \$rest] matches [1 2 3 4 5] → "${result6}"\n`
  );
} catch (e: any) {
  console.log(`❌ Error: ${e.message}\n`);
}
...
`;
  ...
  console.log(
    `✅ PASS: [[\$a \$b] [\$c \$d]] matches [[1 2] [3 4]] → "${result7}"\n`
  );
} catch (e: any) {
  console.log(`❌ Error: ${e.message}\n`);
}
...
console.log(
  "   - Or-Pattern syntax: (1|2|3), ([1|2] \$x), etc."
);
console.log(
  "   - Guard composition: Complex conditions in match arms"
);
console.log(
  "   - Pattern nesting: Deep structures and rest elements\n"
);
